<?php
	...
	$_SESSION['c_out_date']=  $_POST['c_out_date'];
	$aadhar_error=$aadhar="";
	...
	if($aadhar!=NULL and $_POST['c_out_date']!=NULL){
...
?>
<html>
<head><title>Checkout confirmation</title></head>
<body>
<div class="wrapper">
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
    ...
    CHECK-OUT DATE: <input type="date" name="c_out_date" required><br>
